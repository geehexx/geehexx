...
- **Insydo** - Led engineering for a curated Dubai city-guide and recommendation platform across search, recommendations, editorial workflows, and launch delivery.
